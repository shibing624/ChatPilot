...
class ERROR_MESSAGES(str, Enum):
    ...
    INVALID_PASSWORD_FORMAT = "The password format you entered is invalid. Please make sure your password length >= 8."
    INVALID_PASSWORD = (
    ...
    DAILY_TOO_MANY_REQUEST = "Daily request limit reached. Please try again tomorrow."
