...
class AgenticaAssistant:
    def __init__(
        ...
        if enable_run_python_code_tool:
            self.model = PythonAssistant(
                ...
                add_chat_history_to_messages=add_chat_history_to_messages,
    ...
    def stream_run(self, input_str: str):
        ...
        return self.model.run(input_str, stream=True, print_output=self.verbose)
    ...
    def run(self, input_str: str):
        ...
        """
        return self.model.run(input_str, stream=False, print_output=self.verbose)
